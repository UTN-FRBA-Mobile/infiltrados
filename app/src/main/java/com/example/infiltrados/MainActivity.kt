...
import com.example.infiltrados.ui.main.GameSelectionScreen
import com.example.infiltrados.ui.main.JoinGameScreen
        ...
        NavHost(navController = navController, startDestination = "splash") {
            ...
            composable("join_game") {
                JoinGameScreen(
                    navController = navController,
                    onJoinWithCode = { code ->
                        // Lógica para unirte con código (ej. viewModel.joinGame(code))
                    },
                    onScanQrClick = {
                        // Abrir cámara con librería QR (Zxing / MLKit)
                    }
                )
            }
